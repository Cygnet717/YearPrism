    ...
    render(){
        return(
            <div className='test'>
                ...
                <p>Easily find the answers to all these questions and more when you store all your life events and milestones in YearPrism!
                </p>
                <p>Coming Soon: Then find your friends and family and share your life history with them (dont worry you can make events private).
                </p>
